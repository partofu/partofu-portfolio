...
export default function Main() {
  return (
    <div data-header-color="bg-[#f2f2f2]" className="w-full min-h-screen bg-transparent text-[#202020] border border-[#202020] flex flex-col relative overflow-hidden">
      ...
      {/* ================= HERO SECTION ================= */}
      <section className="flex-1 flex items-center justify-center border-b border-[#202020] pt-[70px] bg-[#f2f2f2]">
      ...
      {/* ================= BOTTOM CTA SECTION ================= */}
      <section className="flex items-stretch justify-between border-[#202020] bg-[#f2f2f2]">
        {/* Left - Contact Us */}
